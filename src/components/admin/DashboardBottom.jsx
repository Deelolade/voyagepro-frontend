...
const DashboardBottomBar = () => {
    ...
    return (
        <div className=" bg-white h-[10vh] xxs:h-[9vh] md:h-[9vh] fixed  bottom-0 w-[100vw] md:hidden text-white md:px-5 py-2  flex justify-between shadow-md">
            <div className="links w-[100vw] flex justify-evenly items-center  ">
                ...
                <Link to='' className="user-profile text-white    flex justify-evenly items-center">
