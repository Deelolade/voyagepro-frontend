...
const BreadCrumbs = () => {
  ...
  const signupSteps = [
    ...
    { title: "Verify Email", path: "/verify-otp", icon: <FaChevronRight />, currentStep: 2 },
        ...
        return (
          <div key={step.path} className=''>
            <p className={` flex space-x-2 items-center font-semibold`}>
              ...
              <span className='text-sm'>{step.title}</span><span>{step.icon}</span>
            </p>
