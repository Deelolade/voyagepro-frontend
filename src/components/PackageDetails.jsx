              ...
              <div className="flex mt-4 justify-between">
                ...
                <div className="flex space-x-5 pr-6 items-center">
                  ...
                  <span>
                    ...
                    <p className="text-xl font-medium">{selectedPackage.location.city}</p>
                    <p className="text-sm font-light text-zinc-500">
                      <span>{selectedPackage?.rating}</span>, <span>{selectedPackage?.totalBookings}</span> bookings
                    </p>
                  </span>
                </div>
              </div>
              ...
              <div className=" mt-6">
                <div className="flex space-x-8 justify-start items-center">
                  ...
                  <div className="flex flex-col justify-start items-start text-left">
                    <p className="text-lg font-light mt-8">{selectedPackage.accommodation.roomType}</p>
                    <h3 className="mt-4 text-2xl font-semibold">
                      Accomodation
                    </h3>
                    <p className="text-xl font-light mt-3">{selectedPackage.accommodation.resortType}</p>
