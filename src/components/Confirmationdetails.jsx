                ...
                <div className="py-6 px-4 max-h-screen max-w-7xl mx-auto">
                    ...
                    <div className="2xl:w-[50%] mx-auto mt-4 bg-white p-6 rounded-lg shadow-xl">
                        ...
                        <div className=" mt-3 space-y-2">
                            ...
                            <p className='text-sm '><span className='font-bold me-4'>Date</span> 20sept.2025 - 27sept.2025</p>
                            <p className='text-sm '><span className='font-bold me-4'>Night</span> 7 Nights</p>
                            <p className='text-sm '><span className='font-bold me-4'>Guest</span> 5 Guests</p>
                            <p className='text-sm '><span className='font-bold me-4'>Payment</span> Confirmed</p>
                            <p className='text-sm '><span className='font-bold me-4'>Track</span> Travel</p>
                            <p className='text-sm '><span className='font-bold me-4'>Id Num</span> 1z4s22377990467</p>
                            <p className='text-sm '><span className='font-bold me-4'>Price</span> $ 1,200</p>
                            <p className='text-sm '><span className='font-bold me-4'>Room</span> Standard Room (Duplex)</p>
                        </div>
